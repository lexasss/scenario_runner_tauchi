# This script creates car spawning locations along the trace stored in 'trace.txt' file.

# To create the trace file, uncomment all line below the 'TAUCHI trace' copmment in scenario_manager.py.
# The generated spawning locations will appear in 'spawn_locations.txt' file
...
FILENAME_INPUT = './trace.txt'
FILENAME_OUTPUT = 'spawn_locations.txt'
INTERVAL = 80      # meters
LANE_WIDTH = 3
