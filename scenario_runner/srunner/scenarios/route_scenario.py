...
class DebugMsg(AtomicBehavior):
    def __init__(self, name="CheckPoint"):
        super(DebugMsg, self).__init__(name)
        self.name = name
...
class RouteScenario(BasicScenario):
    ...
    def __init__(self, world, config, debug_mode=False, criteria_enable=True, timeout=300, params=None):
        """
    ...
    def _update_route(self, world, config, debug_mode):
        ...
        self.sampled_scenarios_definitions = self._scenario_sampling(potential_scenarios_definitions, debug_mode)
    ...
    def _update_ego_vehicle(self):
        ...
        # TAUCHI - correct "mkz_2017" is now incorrect "mkz2017". Changed on purpose?
    ...
    def _scenario_sampling(self, potential_scenarios_definitions, random_seed=0, debug_mode=False):
        """
        ...
        for scenario_number, definition in enumerate(scenario_definitions):
            ...
            try:
                scenario_instance = scenario_class(world, [ego_vehicle], scenario_configuration,
                                                   criteria_enable=False, timeout=timeout, params=params)
                ...
                if debug_mode:
                    traceback.print_exc()
                print("ROUTE SCENARIO: Skipping scenario '{}' due to setup error: {}".format(definition['name'], e))
                continue
    ...
    def _initialize_actors(self, config):
        ...
        # TAUCHI - remove all massovka from all cities
        town_amount = {
            # 'Town01': 120,
            # 'Town02': 100,
            # 'Town03': 120,
    ...
    def _create_behavior(self):
        ...
        """
        # TAUCHI: 1.5 >> inf  
        # scenario_trigger_distance = float('inf') # Max trigger distance between route and scenario
        scenario_trigger_distance = 5 # Max trigger distance between route and scenario
        ...
        subbehavior = py_trees.composites.Parallel(name="Behavior",
                                                   # TAUCHI: SUCCESS_ON_ALL >> SUCCESS_ON_ONE
